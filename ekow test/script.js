document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get all CTA buttons (including the one in header)
    ...
    const animateOnScroll = function() {
      const elements = document.querySelectorAll('.card, .target-item, .form-container');
    ...
    const elementsToAnimate = document.querySelectorAll('.card, .target-item, .form-container');
